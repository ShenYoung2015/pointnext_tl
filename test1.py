...
def main():
    ...
    if args.dataset_path is None or args.dataset_path == 'default':
        if args.dataset == 'ModelNet40':
            default_dataset_path_list = [r'D:/database/ModelNet40',
                                         r'/Users/dingziheng/dataset/ModelNet40_points',
                                         r'/root/dataset/ModelNet40_points']
        elif args.dataset == 'shapesffd3':
            default_dataset_path_list = [r'D:/MyCode/PointNet2ptp/PointNet2_mixed/root/shapesffd3']
